  ...
  return (
    <aside className="new-casinos">
      <div className="title-box">
        <h5 className="latest-title">Senast tillagda casino bonusar 20201</h5>
      </div>
      ...
      {newCasino.slice(0, 5).map((casino) => (
        <NewWrapper key={casino.id + casino.color}>
          ...
          <small className="small-new-text">
            {" "}
            18+ | {casino.casinospecialterms}  
            <a href={casino.rules}>Regler & villkor gäller </a> |{" "}
