        ...
        <Container className="app-container">
          ...
          {adBlockEnabled ? (
            <span className="blocker">
              OBS! Du har en Adblocker aktiverad. Sidan kan bete sig lite
          ...
          <Switch>
            ...
            />
            <Route
              path="/Redirect/:casinotitle"
              render={(props) => <RedirectComp list={Casinolist} {...props} />}
            />
            <Route
              path="/odds"
              render={(props) => (
            ...
            />
            <Route path="/kampanjer-casino-2021" component={Blogg} />
            ...
            <Route
              path="/nyheter/:news"
              render={(props) => <News list={Casinolist} {...props} />}
            />
