...
const Casinobonuscomp = (props) => {
  ...
  return (
    <Container className="wrapit ">
      <Helmet>
        <title>
          Casino Bonus 2021⭐ » Bonus Från Svenska Casinon | Casinoniz
        </title>
        ...
        <meta
          ...
          content="Casino bonusar 2020 ✅ ➼ Lista på alla svenska casinon som erbjuder en casino bonus just nu! 
                    Hitta din välkomstbonus. Vi erbjuder en kanske Sverige bästa filterfunktion som hjälper dig att hitta bästa casino bonusen 2021."
        />
        <meta
          name="keywords"
          content="Casino, Casinobonusar,filter,2019,2020 ,2021,esport casinobonus, casino , bonus, filterfunktion, filter, filtrera, bonus trustly, bästa casinobonus, casno, casin, bonos"
        />
      ...
      <h1 className="banners">Casino Bonus</h1>
      <h2 className="second-welcome-title">Casinon med bonusar </h2>
      <StyledSection>
        <div>
          <p>
            En bra casino bonus ger dig extra kronor att spela för. Beroende på
            casino bonus så kan du även få freespins, ibland{" "}
            <b>omsättningsfria freespins</b>. Den bästa casino bonusen som kan
            erbjudas från ett casino är <b>omsättningsfria casino bonusar</b>.
            Det är väldigt få casinon som erbjuder omsättningsfria casino
            bonusar men det finns! Efter att den nya spellagen trädde i kraft
            den <i>1 januari 2019</i> så kan varje casino endast erbjuda 1(en)
            välkomstbonus till spelaren.
          </p>

          <p>
            Vi har listat alla casinon som har en aktiv casino bonus på denna
            sidan. Du kan filtrera casino bonusar och jämföra casino bonusar för
            att hitta en bonus som passar just dig. För att endast filtera
            casinon som erbjuder sport bonus så klickar du in knappen{" "}
            <b>Sportbonus</b> nedanför. Annars listas alla casinon som har en
            aktiv bonus. Hoppas du hittar en casino bonus som ger dig chansen
            till en grym casino upplevelse!{" "}
          </p>
        </div>
      ...
      <StyledH3Sports className={fade ? "fade-in" : "showsports"}>
        {sports
          ? "Visar endast casinon med bonusar & Sportsbetting"
          : "Visar alla casinon med bonusar"}
      </StyledH3Sports>
