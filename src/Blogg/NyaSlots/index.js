  ...
  return (
    <StyledWrapper>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Casino, Casinobonusar, välkomstbonus, 2019,2021, bonus, spela, insättningsbonus,videoslots,nytt free spins, faktura casino, casino faktura, bästa casinon,nya,publicerade,licenserade,svenska,casinon, bästa casinon 2021, nya slots 2021, videospel,"
        />
      ...
      <h1 className="banners">Nya Slots 2021 </h1>
      <small> Uppdaterad: 27 Februari 2021</small>

      <h2>Nya Slots 2021 - Lista på nya grymma videoslots för 2021</h2>
      <section className="welcome-box-newslots">
        <div>
          <p>
            Nya slots 2021 som är värda att nämna. Denna sektionen kommer
            uppdateras kontinuerligt så håll koll på denna sidan. Vi på
            Casinoniz.se tror att detta året kommer bjuda på många nya
            videoslots med väldigt spännande och grymma upplevelser.{" "}
          </p>

          <p>
            Här kommer vi lista nya slots från detta året. Listan kommer att
            uppdateras med slots som vi på Casinoniz tycker är värda att nämna.
            Klicka på namnet på önskad slot för läsa mer om spelet!
          </p>
        </div>
        <img className="piggy" src="/images/pig.svg" alt="piggy" />
      </section>
      <h2 className="btn-title">
        Klicka på knapparna för mer information om enskild slot
      </h2>

      <StyledKommande>
        <h2>Kommande slots 2021</h2>
      ...
      {slotLists.outnow
        ...
        .reverse()
        .map((slot, e) => (
          <NewSlotComp key={slot.id} slot={slot} casino={props.list.Casinon} />
        ))}
