        ...
        <div className="terms-wrap">
            ...
            <div className="text-body">
                ...
                <p>
                    ...
                    garanterar några vinster och att de riskerar att förlora pengar när
                    de spelar hos spelbolag online. Casinoniz.se står inte för förlorade
                ...
                <h3>Spelproblem</h3>
                Spel med pengar ska vara kul, men det kan lätt gå överstyr och ifall
                du som besökare känner att du spelar för mycket och för mer pengar än
          du har råd med så finns hjälp att få hos{" "}
                <a href="https://spelberoende.se/" alt="Spelberoende">
                    Spelberoende.se
          </a>
                <p>
                    Du kan även spärra dig från ALLT spel hos spelbolag som innehar
            svensk spellicense hos{" "}
